...
// 附：常用热物性参数速查
const propertyTable = [
  ["纯铜 (C1100)", "401", "8930", "385", "117"],
  ["纯铝 (1060)", "234", "2700", "900", "96.3"],
  ["6061 铝合金", "167", "2700", "896", "69.0"],
  ["ADC12 压铸铝", "96", "2700", "960", "37.0"],
  ["铜钨合金 (WCu)", "180~230", "15000~17000", "180~200", "70~76"],
  ["氧化铝陶瓷 Al₂O₃", "25~35", "3900", "880", "8.7"],
  ["氮化铝 AlN", "170~200", "3260", "740", "74~77"],
  ["FR4 (玻纤环氧)", "0.3", "1900", "1300", "0.12"],
  ["导热硅脂 (优质)", "8~12", "~2500", "—", "—"],
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-tech-600/30 text-gray-400">
                ...
                <th className="text-right py-2 px-3 font-mono">α (×10⁻⁶ m²/s)</th>
              </tr>
            </thead>
            <tbody>
